...
def scrape_and_process_wiki(wiki_link: str, output_path: str):
    # Download the content
    response = requests.get(wiki_link)
    response.encoding = 'utf-8'  # Set encoding for response
    
    # Write it to a file
    with open("history.html", "w", encoding="utf-8") as f:
        f.write(response.text)
    
    # Load and parse HTML directly with BeautifulSoup
...
if __name__ == "__main__":
    ...
    output_path = r"D:\R3-demo\full_chronology.xlsx"
